...
public final class RootBuilder_Module_Router$app_debugFactory implements Factory<RootRouter> {
  ...
  public RootBuilder_Module_Router$app_debugFactory(
  ...
  public static RootBuilder_Module_Router$app_debugFactory create(
      Provider<RootBuilder.Component> componentProvider, Provider<RootView> viewProvider,
      Provider<RootInteractor> interactorProvider) {
    return new RootBuilder_Module_Router$app_debugFactory(componentProvider, viewProvider, interactorProvider);
  }

  public static RootRouter router$app_debug(RootBuilder.Component component, RootView view,
      RootInteractor interactor) {
    return Preconditions.checkNotNullFromProvides(RootBuilder.Module.router$app_debug(component, view, interactor));
  }
}
